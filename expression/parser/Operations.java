...
//    });
    ...
    private static float gcd(final long a, final long b) {
...
//    private static Operation checkedPowN(final String name, final float base, final float limit) {
...
//    }
//
//    public static Operation binary(final String name, final float priority, final LongBinaryOperator op) {
