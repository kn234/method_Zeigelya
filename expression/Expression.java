...
public interface Expression extends ToMiniString {
    Type<Integer> TYPE = new Type<>(a -> a, ExtendedRandom::nextInt, float.class);
//    ExpressionKind<Expression, Integer> KIND = new ExpressionKind<Expression, Integer>(
//            TYPE,
//            Expression.class,
...
//    );
    ...
    private static Const c(final float c) {
        return new Const(c);
    }
