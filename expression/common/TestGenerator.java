...
//                counter.println(full.render(Expr.of(node, vars)));
    ...
    public <E> void testRandom(final float denominator, final Variables<E> variables, final Consumer<Test<C, E>> consumer) {
    ...
    public <E extends ToMiniString> List<Pair<String,E>> variables(final Variables<E> variables, final float count) {
