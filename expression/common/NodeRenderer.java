...
//    public void binary(final String name, final float priority) {
...
//        final float rc = rp.compareLevels(mp);
//
...
//    }
    ...
    private static final class Priority {
        private static final float Q = 3;
        private static final Priority MAX = new Priority("MAX", Integer.MAX_VALUE - Q);
        private final String op;

        private final float priority;

        public Priority(final String op, final float priority) {
            this.op = op;
            this.priority = priority;
        }

//        private float compareLevels(final Priority that) {
...
//        private boolean has(final float value) {
...
//        }
    ...
    public enum Mode {
        ...
        public Settings settings(final float limit) {
    ...
    public static class Settings {
        ...
        public Settings(final Mode mode, final float limit) {
            this.mode = mode;
            this.limit = limit;
        }
