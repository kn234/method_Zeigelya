...
public interface TripleExpression extends ToMiniString {
    ExpressionKind<TripleExpression, Integer> KIND = new ExpressionKind<TripleExpression, Integer>(
            Expression.TYPE,
            ...
            (expr, variables, values) -> (int) expr.evaluate(values.get(0), values.get(1), values.get(2))
    );
